...
const OutputSchema = z.object({
  ...
  hint: z.string().describe("An enthusiastic, personable, and short conversational response (1-2 sentences) explaining why you chose these specific products and why they are great for the user's context. Give the agent a helpful and friendly personality. This MUST be provided. e.g. 'I found these gorgeous sarees that are perfect for your mother! They are incredibly popular and make for a wonderful, thoughtful gift.'"),
